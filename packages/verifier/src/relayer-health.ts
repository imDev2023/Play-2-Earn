 ...
 *
 * It lives in the shared package, rather than in the admin console where it started,
 * because the relayer's own pager consumes it too (#39). If the console and the pager
 * each carried their own copy of this state machine they could disagree, and the
 * failure that produces - a console showing green while nobody is being paged - is
 * exactly the one the alerting exists to prevent. One definition, two readers.
 */

/**
 * How long an unsettled bet may sit before it is called a problem.
 *
